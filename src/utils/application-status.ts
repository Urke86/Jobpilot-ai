...
export function getStageBadgeClass(stage: ApplicationStage): string {
...
export function getColumnHeaderClass(stage: ApplicationStage): string {
  const styles: Record<ApplicationStage, string> = {
...
export function getColumnBorderClass(stage: ApplicationStage): string {
  const styles: Record<ApplicationStage, string> = {
